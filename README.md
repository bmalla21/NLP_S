 Scrape a bunch of Twitter data from the last election cycle, say from the Republican primaries, and use a sentiment classifier to plot the popularity of each candidate across time. 
